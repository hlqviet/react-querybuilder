...
__export(src_exports, {
  ...
  QueryBuilderStateContext: () => QueryBuilderStateContext,
  QueryBuilderStateProvider: () => QueryBuilderStateProvider,
  Rule: () => Rule,
  RuleComponents: () => RuleComponents,
  RuleGroup: () => RuleGroup,
  RuleGroupBodyComponents: () => RuleGroupBodyComponents,
  RuleGroupHeaderComponents: () => RuleGroupHeaderComponents,
  ShiftActions: () => ShiftActions,
  TestID: () => TestID,
  ValueEditor: () => ValueEditor,
  ValueSelector: () => ValueSelector,
  add: () => add,
  convertFromIC: () => convertFromIC,
  convertQuery: () => convertQuery,
  convertToIC: () => convertToIC,
  default: () => QueryBuilder,
  defaultCELValueProcessor: () => defaultCELValueProcessor,
  defaultCombinators: () => defaultCombinators,
  defaultCombinatorsExtended: () => defaultCombinatorsExtended,
  defaultControlClassnames: () => defaultControlClassnames,
  defaultControlElements: () => defaultControlElements,
  defaultJoinChar: () => defaultJoinChar,
  defaultMongoDBValueProcessor: () => defaultMongoDBValueProcessor,
  defaultOperatorNegationMap: () => defaultOperatorNegationMap,
  defaultOperators: () => defaultOperators,
  defaultPlaceholderFieldGroupLabel: () => defaultPlaceholderFieldGroupLabel,
  defaultPlaceholderFieldLabel: () => defaultPlaceholderFieldLabel,
  defaultPlaceholderFieldName: () => defaultPlaceholderFieldName,
  defaultPlaceholderOperatorGroupLabel: () => defaultPlaceholderOperatorGroupLabel,
  defaultPlaceholderOperatorLabel: () => defaultPlaceholderOperatorLabel,
  defaultPlaceholderOperatorName: () => defaultPlaceholderOperatorName,
  ...
  filterFieldsByComparator: () => filterFieldsByComparator,
  findPath: () => findPath,
  formatQuery: () => formatQuery,
  generateAccessibleDescription: () => generateAccessibleDescription,
  generateID: () => generateID,
  getCommonAncestorPath: () => getCommonAncestorPath,
  getCompatContextProvider: () => getCompatContextProvider,
  getFirstOption: () => getFirstOption,
  getOption: () => getOption,
  getParentPath: () => getParentPath,
  getQuerySelectorById: () => getQuerySelectorById,
  getValidationClassNames: () => getValidationClassNames,
  getValueSourcesUtil: () => getValueSourcesUtil,
  groupInvalidReasons: () => groupInvalidReasons,
  isAncestor: () => isAncestor,
  isFlexibleOptionGroupArray: () => isFlexibleOptionGroupArray,
  isFullOptionGroupArray: () => isFullOptionGroupArray,
  isOptionGroupArray: () => isOptionGroupArray,
  isPojo: () => isPojo,
  isRuleGroup: () => isRuleGroup,
  isRuleGroupType: () => isRuleGroupType,
  isRuleGroupTypeIC: () => isRuleGroupTypeIC,
  isRuleOrGroupValid: () => isRuleOrGroupValid,
  ...
  messages: () => messages,
  move: () => move,
  nullFreeArray: () => nullFreeArray,
  numericRegex: () => numericRegex,
  objectEntries: () => objectEntries,
  objectKeys: () => objectKeys,
  parseNumber: () => parseNumber,
  pathIsDisabled: () => pathIsDisabled,
  pathsAreEqual: () => pathsAreEqual,
  prepareRule: () => prepareRule,
  prepareRuleGroup: () => prepareRuleGroup,
  prepareRuleOrGroup: () => prepareRuleOrGroup,
  ...
  toArray: () => toArray,
  toFlatOptionArray: () => toFlatOptionArray,
  toFullOption: () => toFullOption,
  toFullOptionList: () => toFullOptionList,
  toFullOptionMap: () => toFullOptionMap,
  toOptions: () => toOptions,
  transformQuery: () => transformQuery,
  trimIfString: () => trimIfString,
  uniqByIdentifier: () => uniqByIdentifier,
  uniqByName: () => uniqByName,
  uniqOptGroups: () => uniqOptGroups,
  uniqOptList: () => uniqOptList,
  update: () => update,
  useControlledOrUncontrolled: () => useControlledOrUncontrolled,
  useDeprecatedProps: () => useDeprecatedProps,
  useMergedContext: () => useMergedContext,
  usePreferAnyProp: () => usePreferAnyProp,
  usePreferProp: () => usePreferProp,
  usePrevious: () => usePrevious,
  useQueryBuilderSchema: () => useQueryBuilderSchema,
  useQueryBuilderSelector: () => useQueryBuilderSelector,
  useQueryBuilderSetup: () => useQueryBuilderSetup,
  useReactDndWarning: () => useReactDndWarning,
  useRule: () => useRule,
  useRuleGroup: () => useRuleGroup,
  useSelectElementChangeHandler: () => useSelectElementChangeHandler,
  useStopEventPropagation: () => useStopEventPropagation,
  useValueEditor: () => useValueEditor,
  useValueSelector: () => useValueSelector
});
...
var DragHandle = (0, import_react.forwardRef)((props, dragRef) => /* @__PURE__ */ React2.createElement("span", { "data-testid": props.testID, ref: dragRef, className: props.className, title: props.title }, props.label));
...
var initialState = {};
var queriesSlice = (0, import_toolkit.createSlice)({
  name: "queries",
  initialState,
  reducers: {
...
var warningsSlice = (0, import_toolkit2.createSlice)({
  name: "warnings",
...
var queryBuilderStore = (0, import_toolkit3.configureStore)({
  reducer: {
...
var useQueryBuilderSelector = (0, import_react_redux.createSelectorHook)(QueryBuilderStateContext);
...
var useRQB_INTERNAL_QueryBuilderDispatch = (0, import_react_redux2.createDispatchHook)(QueryBuilderStateContext);
var useRQB_INTERNAL_QueryBuilderStore = (0, import_react_redux2.createStoreHook)(QueryBuilderStateContext);
...
var usePrevious = (value) => {
  const ref = (0, import_react2.useRef)({ value, prev: null });
...
var mergeClassnames = (...args) => {
  const joinClassnamesByName = (name) => (0, import_clsx.default)(args.filter(Boolean).map((c) => (0, import_clsx.default)(c[name])));
  return {
...
var mergeTranslations = (...args) => {
  ...
  return (0, import_immer2.produce)(base ?? defaultTranslationsBase, (draft) => {
...
var getCompatContextProvider = (gccpProps) => {
  ...
  return (props) => {
    ...
    const newTranslations = (0, import_react3.useMemo)(
...
} = {}) => (0, import_immer4.produce)(query, (draft) => {
...
var remove = (query, path) => {
  ...
  return (0, import_immer4.produce)(query, (draft) => {
...
var remapProperties = (obj, propertyMap, deleteRemappedProperties) => (0, import_immer5.produce)(obj, (draft) => {
...
var usePreferProp = (def, prop, context) => (0, import_react4.useMemo)(() => preferProp(def, prop, context), [context, def, prop]);
var usePreferAnyProp = (def, prop, context) => (0, import_react4.useMemo)(
...
// src/hooks/useMergedContext.ts
var nullComp = () => null;
var nullFwdComp = (0, import_react5.forwardRef)(nullComp);
var useMergedContext = (props) => {
  const rqbContext = (0, import_react5.useContext)(QueryBuilderContext);
  ...
  const controlClassnames = (0, import_react5.useMemo)(
    () => mergeClassnames(
  ...
  const controlElements = (0, import_react5.useMemo)(() => {
  ...
  const translations = (0, import_react5.useMemo)(
    () => mergeTranslations(
      defaultTranslations,
...
function useQueryBuilderSchema(props, setup) {
  ...
  const querySelector = (0, import_react6.useMemo)(() => getQuerySelectorById(setup.qbId), [setup.qbId]);
  const storeQuery = useQueryBuilderSelector(querySelector);
  const getQuery = (0, import_react6.useCallback)(
    () => querySelector(queryBuilderStore2.getState()),
    [queryBuilderStore2, querySelector]
  );
  const fallbackQuery = (0, import_react6.useMemo)(() => createRuleGroup(), [createRuleGroup]);
  ...
  const independentCombinators = (0, import_react6.useMemo)(() => isRuleGroupTypeIC(rootGroup), [rootGroup]);
  ...
  const hasRunMountQueryChange = (0, import_react6.useRef)(false);
  (0, import_react6.useEffect)(() => {
  ...
  const dispatchQuery = (0, import_react6.useCallback)(
    (newQuery) => {
      queryBuilderDispatch(
  ...
  const disabledPaths = (0, import_react6.useMemo)(() => Array.isArray(disabled) && disabled || [], [disabled]);
  const queryDisabled = disabled === true;
  const rootGroupDisabled = (0, import_react6.useMemo)(
    () => rootGroup.disabled || disabledPaths.some((p) => p.length === 0),
    [disabledPaths, rootGroup.disabled]
  );
  const onRuleAdd = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const onGroupAdd = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const onPropChange = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (prop, value, path) => {
      const queryLocal = getQuerySelectorById(qbId)(queryBuilderStore2.getState());
      if (!queryLocal)
  ...
  const onRuleOrGroupRemove = (0, import_react6.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (path, context) => {
      const queryLocal = getQuerySelectorById(qbId)(queryBuilderStore2.getState());
      if (!queryLocal)
  ...
  const moveRule = (0, import_react6.useCallback)(
  ...
  const wrapperClassName = (0, import_react6.useMemo)(
    () => (0, import_clsx2.clsx)(standardClassnames.queryBuilder, (0, import_clsx2.clsx)(controlClassnames.queryBuilder), {
...
var useQueryBuilderSetup = (props) => {
  const [qbId] = (0, import_react7.useState)(generateID);
  const {
  ...
  const defaultField = (0, import_react7.useMemo)(
    () => ({
  ...
  const fieldsProp = (0, import_react7.useMemo)(
  ...
  const fieldMap = (0, import_react7.useMemo)(() => {
  ...
  const combinators = (0, import_react7.useMemo)(
    () => toFullOptionList(combinatorsProp, baseCombinator),
    [baseCombinator, combinatorsProp]
  );
  const defaultOperator = (0, import_react7.useMemo)(
    () => ({
  ...
  const getOperatorsMain = (0, import_react7.useCallback)(
    (field, { fieldData }) => {
  ...
  const getRuleDefaultOperator = (0, import_react7.useCallback)(
    (field) => {
  ...
  const getValueEditorTypeMain = (0, import_react7.useCallback)(
  ...
  const getValueSourcesMain = (0, import_react7.useCallback)(
    (field, operator) => getValueSourcesUtil(fieldMap[field], operator, getValueSources),
    [fieldMap, getValueSources]
  );
  const getValuesMain = (0, import_react7.useCallback)(
    (field, operator, { fieldData }) => {
      if (fieldData?.values) {
  ...
  const getRuleDefaultValue = (0, import_react7.useCallback)(
    (r) => {
  ...
  const getInputTypeMain = (0, import_react7.useCallback)(
    (field, operator, { fieldData }) => {
      if (getInputType) {
  ...
  const createRule = (0, import_react7.useCallback)(() => {
    let field = "";
    const flds = fields;
  ...
  const createRuleGroup = (0, import_react7.useCallback)(
    (independentCombinators) => {
...
var useRule = (props) => {
  ...
  const rule = (0, import_react8.useMemo)(
    () => ruleProp ? ruleProp : {
      id,
  ...
  const classNames = (0, import_react8.useMemo)(
    () => ({
      shiftActions: (0, import_clsx3.clsx)(standardClassnames.shiftActions, classNamesProp.shiftActions),
      dragHandle: (0, import_clsx3.clsx)(standardClassnames.dragHandle, classNamesProp.dragHandle),
      fields: (0, import_clsx3.clsx)(standardClassnames.fields, classNamesProp.valueSelector, classNamesProp.fields),
      operators: (0, import_clsx3.clsx)(
        standardClassnames.operators,
        classNamesProp.valueSelector,
        classNamesProp.operators
      ),
      valueSource: (0, import_clsx3.clsx)(
        standardClassnames.valueSource,
        classNamesProp.valueSelector,
        classNamesProp.valueSource
      ),
      value: (0, import_clsx3.clsx)(standardClassnames.value, classNamesProp.value),
      cloneRule: (0, import_clsx3.clsx)(
        standardClassnames.cloneRule,
        classNamesProp.actionElement,
        classNamesProp.cloneRule
      ),
      lockRule: (0, import_clsx3.clsx)(
        standardClassnames.lockRule,
        classNamesProp.actionElement,
        classNamesProp.lockRule
      ),
      removeRule: (0, import_clsx3.clsx)(
  ...
  const generateOnChangeHandler = (0, import_react8.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (prop) => (value, _context) => {
      if (!disabled) {
  ...
  const cloneRule = (0, import_react8.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
  ...
  const toggleLockRule = (0, import_react8.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
  ...
  const removeRule = (0, import_react8.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
        onRuleRemove(path);
  ...
  const shiftRuleUp = (0, import_react8.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
  ...
  const shiftRuleDown = (0, import_react8.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
  ...
  const valueSources = (0, import_react8.useMemo)(
  ...
  const valueEditorType = (0, import_react8.useMemo)(
  ...
  const valueEditorSeparator = (0, import_react8.useMemo)(
  ...
  const valueSourceOptions = (0, import_react8.useMemo)(
    () => valueSources.map((vs) => ({ name: vs, value: vs, label: vs })),
    [valueSources]
  );
  const validationResult = (0, import_react8.useMemo)(
  ...
  const validationClassName = (0, import_react8.useMemo)(
    () => getValidationClassNames(validationResult),
    [validationResult]
  );
  const fieldBasedClassName = (0, import_react8.useMemo)(() => fieldData?.className ?? "", [fieldData?.className]);
  const operatorBasedClassName = (0, import_react8.useMemo)(
    () => operatorObject?.className ?? "",
    [operatorObject?.className]
  );
  const outerClassName = (0, import_clsx3.clsx)(
...
var useRuleGroup = (props) => {
  ...
  const disabled = !!parentDisabled || !!disabledProp;
  const combinator = (0, import_react9.useMemo)(
  ...
  const ruleGroup = (0, import_react9.useMemo)(
  ...
  const classNames = (0, import_react9.useMemo)(
    () => ({
      header: (0, import_clsx4.clsx)(standardClassnames.header, classNamesProp.header, {
        [standardClassnames.dndOver]: isOver
      }),
      shiftActions: (0, import_clsx4.clsx)(standardClassnames.shiftActions, classNamesProp.shiftActions),
      dragHandle: (0, import_clsx4.clsx)(standardClassnames.dragHandle, classNamesProp.dragHandle),
      combinators: (0, import_clsx4.clsx)(
        standardClassnames.combinators,
        classNamesProp.valueSelector,
        classNamesProp.combinators
      ),
      notToggle: (0, import_clsx4.clsx)(standardClassnames.notToggle, classNamesProp.notToggle),
      addRule: (0, import_clsx4.clsx)(
        standardClassnames.addRule,
        classNamesProp.actionElement,
        classNamesProp.addRule
      ),
      addGroup: (0, import_clsx4.clsx)(
        standardClassnames.addGroup,
        classNamesProp.actionElement,
        classNamesProp.addGroup
      ),
      cloneGroup: (0, import_clsx4.clsx)(
        standardClassnames.cloneGroup,
        classNamesProp.actionElement,
        classNamesProp.cloneGroup
      ),
      lockGroup: (0, import_clsx4.clsx)(
        standardClassnames.lockGroup,
        classNamesProp.actionElement,
        classNamesProp.lockGroup
      ),
      removeGroup: (0, import_clsx4.clsx)(
        standardClassnames.removeGroup,
        classNamesProp.actionElement,
        classNamesProp.removeGroup
      ),
      body: (0, import_clsx4.clsx)(standardClassnames.body, classNamesProp.body)
    }),
    [
      classNamesProp.actionElement,
      classNamesProp.addGroup,
  ...
  const onCombinatorChange = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (value, _context) => {
      if (!disabled) {
  ...
  const onIndependentCombinatorChange = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  const onNotToggleChange = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (checked, _context) => {
      if (!disabled) {
  ...
  const addRule = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, context) => {
      if (!disabled) {
  ...
  const addGroup = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, context) => {
      if (!disabled) {
  ...
  const cloneGroup = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
        const newPath = [...getParentPath(path), path[path.length - 1] + 1];
  ...
  const shiftGroupUp = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
      if (!disabled && !shiftUpDisabled) {
        moveRule(path, "up", event?.altKey);
  ...
  const shiftGroupDown = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event, _context) => {
      if (!disabled && !shiftDownDisabled) {
        moveRule(path, "down", event?.altKey);
  ...
  const toggleLockGroup = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      onPropChange("disabled", !disabled, path);
    },
  ...
  const removeGroup = (0, import_react9.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (_event, _context) => {
      if (!disabled) {
        onGroupRemove(path);
  ...
  const validationResult = (0, import_react9.useMemo)(
    () => validationMap[id ?? /* istanbul ignore next */
    ""],
    [id, validationMap]
  );
  const validationClassName = (0, import_react9.useMemo)(
    () => getValidationClassNames(validationResult),
    [validationResult]
  );
  const combinatorBasedClassName = (0, import_react9.useMemo)(
    () => independentCombinators ? null : getOption(combinators, combinator)?.className ?? "",
    [combinator, combinators, independentCombinators]
  );
  const ruleGroupClassname = (0, import_react9.useMemo)(
    () => getRuleGroupClassname(ruleGroup),
    [getRuleGroupClassname, ruleGroup]
  );
  const outerClassName = (0, import_react9.useMemo)(
    () => (0, import_clsx4.clsx)(
      ruleGroupClassname,
  ...
  const pathsMemo = (0, import_react9.useMemo)(() => {
    const paths = [];
  ...
  const accessibleDescription = (0, import_react9.useMemo)(
...
var useSelectElementChangeHandler = (params) => {
  ...
  const selectElementChangeHandler = (0, import_react10.useMemo)(
...
var useStopEventPropagation = (method) => (0, import_react11.useCallback)(
  (event, context) => {
...
var useValueEditor = (props) => {
  ...
  const valueAsArray = (0, import_react12.useMemo)(() => toArray(value), [value]);
  const multiValueHandler = (0, import_react12.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (v, i) => {
      const val = (0, import_immer6.produce)(valueAsArray, (va) => {
...
var useValueSelector = (props) => {
  ...
  const val = (0, import_react13.useMemo)(() => multiple ? toArray(value) : value, [multiple, value]);
  return {
    /**
...
var QueryBuilderContext = (0, import_react14.createContext)({});

// src/components/QueryBuilder.tsx
var rootPath = [];
var QueryBuilderStateProvider = (props) => /* @__PURE__ */ React8.createElement(import_react_redux3.Provider, { context: QueryBuilderStateContext, store: queryBuilderStore }, props.children);
...
//# sourceMappingURL=react-querybuilder.cjs.development.js.map