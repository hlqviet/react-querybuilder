...
var joinWith = (strArr, joinChar = defaultJoinChar) => strArr.map((str) => `${str != null ? str : ""}`.replaceAll(joinChar, `\\${joinChar}`)).join(joinChar);
...
var getFirstOption = (arr) => {
  var _a, _b;
  return !Array.isArray(arr) || arr.length === 0 ? null : isFlexibleOptionGroupArray(arr) ? (_a = arr[0].options[0].value) != null ? _a : arr[0].options[0].name : (_b = arr[0].value) != null ? _b : arr[0].name;
};
...
var mergeTranslations = (...args) => {
  ...
  return produce2(base != null ? base : defaultTranslationsBase, (draft) => {
    for (const translations of otherTranslations) {
      if (!translations)
        continue;
      objectKeys(translations).forEach((t) => {
        draft[t] = __spreadValues(__spreadValues({}, draft[t]), translations[t]);
      });
    }
  });
};
...
var getCompatContextProvider = (gccpProps) => {
  ...
  return (props) => {
    ...
    const newContextProps = useMemo(
      () => __spreadProps(__spreadValues(__spreadValues({}, rqbContext), classnamesObject), {
        controlElements: __spreadValues(__spreadValues(__spreadValues({}, rqbContext.controlElements), compatElements), props.controlElements),
...
var useMergedContext = (props) => {
  ...
  const controlElements = useMemo3(() => {
    var _a2, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W, _X, _Y, _Z, __, _$, _aa, _ba, _ca, _da, _ea, _fa, _ga, _ha, _ia, _ja, _ka, _la, _ma, _na, _oa, _pa, _qa, _ra, _sa, _ta, _ua, _va, _wa, _xa, _ya, _za, _Aa, _Ba, _Ca, _Da, _Ea, _Fa, _Ga, _Ha, _Ia, _Ja, _Ka, _La, _Ma, _Na, _Oa, _Pa, _Qa, _Ra, _Sa, _Ta, _Ua, _Va, _Wa, _Xa, _Ya, _Za, __a, _$a, _ab, _bb, _cb, _db;
    const contextControlElements = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, rqbContext.controlElements), ((_a2 = rqbContext.controlElements) == null ? void 0 : _a2.dragHandle) === null ? { dragHandle: nullFwdComp } : {}), ((_b = rqbContext.controlElements) == null ? void 0 : _b.inlineCombinator) === null ? { inlineCombinator: nullComp } : {}), ((_c = rqbContext.controlElements) == null ? void 0 : _c.notToggle) === null ? { notToggle: nullComp } : {}), ((_d = rqbContext.controlElements) == null ? void 0 : _d.shiftActions) === null ? { shiftActions: nullComp } : {}), ((_e = rqbContext.controlElements) == null ? void 0 : _e.valueEditor) === null ? { valueEditor: nullComp } : {}), ((_f = rqbContext.controlElements) == null ? void 0 : _f.valueSourceSelector) === null ? { valueSourceSelector: nullComp } : {}), ((_g = rqbContext.controlElements) == null ? void 0 : _g.addGroupAction) === null ? { addGroupAction: nullComp } : {}), ((_h = rqbContext.controlElements) == null ? void 0 : _h.addRuleAction) === null ? { addRuleAction: nullComp } : {}), ((_i = rqbContext.controlElements) == null ? void 0 : _i.cloneGroupAction) === null ? { cloneGroupAction: nullComp } : {}), ((_j = rqbContext.controlElements) == null ? void 0 : _j.cloneRuleAction) === null ? { cloneRuleAction: nullComp } : {}), ((_k = rqbContext.controlElements) == null ? void 0 : _k.lockGroupAction) === null ? { lockGroupAction: nullComp } : {}), ((_l = rqbContext.controlElements) == null ? void 0 : _l.lockRuleAction) === null ? { lockRuleAction: nullComp } : {}), ((_m = rqbContext.controlElements) == null ? void 0 : _m.removeGroupAction) === null ? { removeGroupAction: nullComp } : {}), ((_n = rqbContext.controlElements) == null ? void 0 : _n.removeRuleAction) === null ? { removeRuleAction: nullComp } : {}), ((_o = rqbContext.controlElements) == null ? void 0 : _o.combinatorSelector) === null ? { combinatorSelector: nullComp } : {}), ((_p = rqbContext.controlElements) == null ? void 0 : _p.fieldSelector) === null ? { fieldSelector: nullComp } : {}), ((_q = rqbContext.controlElements) == null ? void 0 : _q.operatorSelector) === null ? { operatorSelector: nullComp } : {}), ((_r = rqbContext.controlElements) == null ? void 0 : _r.valueSourceSelector) === null ? { valueSourceSelector: nullComp } : {}), ((_s = rqbContext.controlElements) == null ? void 0 : _s.actionElement) ? {
      addGroupAction: ((_t = rqbContext.controlElements) == null ? void 0 : _t.addGroupAction) === null ? nullComp : (_v = (_u = rqbContext.controlElements) == null ? void 0 : _u.addGroupAction) != null ? _v : rqbContext.controlElements.actionElement,
      addRuleAction: ((_w = rqbContext.controlElements) == null ? void 0 : _w.addRuleAction) === null ? nullComp : (_y = (_x = rqbContext.controlElements) == null ? void 0 : _x.addRuleAction) != null ? _y : rqbContext.controlElements.actionElement,
      cloneGroupAction: ((_z = rqbContext.controlElements) == null ? void 0 : _z.cloneGroupAction) === null ? nullComp : (_B = (_A = rqbContext.controlElements) == null ? void 0 : _A.cloneGroupAction) != null ? _B : rqbContext.controlElements.actionElement,
      cloneRuleAction: ((_C = rqbContext.controlElements) == null ? void 0 : _C.cloneRuleAction) === null ? nullComp : (_E = (_D = rqbContext.controlElements) == null ? void 0 : _D.cloneRuleAction) != null ? _E : rqbContext.controlElements.actionElement,
      lockGroupAction: ((_F = rqbContext.controlElements) == null ? void 0 : _F.lockGroupAction) === null ? nullComp : (_H = (_G = rqbContext.controlElements) == null ? void 0 : _G.lockGroupAction) != null ? _H : rqbContext.controlElements.actionElement,
      lockRuleAction: ((_I = rqbContext.controlElements) == null ? void 0 : _I.lockRuleAction) === null ? nullComp : (_K = (_J = rqbContext.controlElements) == null ? void 0 : _J.lockRuleAction) != null ? _K : rqbContext.controlElements.actionElement,
      removeGroupAction: ((_L = rqbContext.controlElements) == null ? void 0 : _L.removeGroupAction) === null ? nullComp : (_N = (_M = rqbContext.controlElements) == null ? void 0 : _M.removeGroupAction) != null ? _N : rqbContext.controlElements.actionElement,
      removeRuleAction: ((_O = rqbContext.controlElements) == null ? void 0 : _O.removeRuleAction) === null ? nullComp : (_Q = (_P = rqbContext.controlElements) == null ? void 0 : _P.removeRuleAction) != null ? _Q : rqbContext.controlElements.actionElement
    } : {}), ((_R = rqbContext.controlElements) == null ? void 0 : _R.valueSelector) ? {
      combinatorSelector: ((_S = rqbContext.controlElements) == null ? void 0 : _S.combinatorSelector) === null ? nullComp : (_U = (_T = rqbContext.controlElements) == null ? void 0 : _T.combinatorSelector) != null ? _U : rqbContext.controlElements.valueSelector,
      fieldSelector: ((_V = rqbContext.controlElements) == null ? void 0 : _V.fieldSelector) === null ? nullComp : (_X = (_W = rqbContext.controlElements) == null ? void 0 : _W.fieldSelector) != null ? _X : rqbContext.controlElements.valueSelector,
      operatorSelector: ((_Y = rqbContext.controlElements) == null ? void 0 : _Y.operatorSelector) === null ? nullComp : (__ = (_Z = rqbContext.controlElements) == null ? void 0 : _Z.operatorSelector) != null ? __ : rqbContext.controlElements.valueSelector,
      valueSourceSelector: ((_$ = rqbContext.controlElements) == null ? void 0 : _$.valueSourceSelector) === null ? nullComp : (_ba = (_aa = rqbContext.controlElements) == null ? void 0 : _aa.valueSourceSelector) != null ? _ba : rqbContext.controlElements.valueSelector
    } : {});
    const propsControlElements = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, props.controlElements), ((_ca = props.controlElements) == null ? void 0 : _ca.dragHandle) === null ? { dragHandle: nullFwdComp } : {}), ((_da = props.controlElements) == null ? void 0 : _da.inlineCombinator) === null ? { inlineCombinator: nullComp } : {}), ((_ea = props.controlElements) == null ? void 0 : _ea.notToggle) === null ? { notToggle: nullComp } : {}), ((_fa = props.controlElements) == null ? void 0 : _fa.shiftActions) === null ? { shiftActions: nullComp } : {}), ((_ga = props.controlElements) == null ? void 0 : _ga.valueEditor) === null ? { valueEditor: nullComp } : {}), ((_ha = props.controlElements) == null ? void 0 : _ha.valueSourceSelector) === null ? { valueSourceSelector: nullComp } : {}), ((_ia = props.controlElements) == null ? void 0 : _ia.addGroupAction) === null ? { addGroupAction: nullComp } : {}), ((_ja = props.controlElements) == null ? void 0 : _ja.addRuleAction) === null ? { addRuleAction: nullComp } : {}), ((_ka = props.controlElements) == null ? void 0 : _ka.cloneGroupAction) === null ? { cloneGroupAction: nullComp } : {}), ((_la = props.controlElements) == null ? void 0 : _la.cloneRuleAction) === null ? { cloneRuleAction: nullComp } : {}), ((_ma = props.controlElements) == null ? void 0 : _ma.lockGroupAction) === null ? { lockGroupAction: nullComp } : {}), ((_na = props.controlElements) == null ? void 0 : _na.lockRuleAction) === null ? { lockRuleAction: nullComp } : {}), ((_oa = props.controlElements) == null ? void 0 : _oa.removeGroupAction) === null ? { removeGroupAction: nullComp } : {}), ((_pa = props.controlElements) == null ? void 0 : _pa.removeRuleAction) === null ? { removeRuleAction: nullComp } : {}), ((_qa = props.controlElements) == null ? void 0 : _qa.combinatorSelector) === null ? { combinatorSelector: nullComp } : {}), ((_ra = props.controlElements) == null ? void 0 : _ra.fieldSelector) === null ? { fieldSelector: nullComp } : {}), ((_sa = props.controlElements) == null ? void 0 : _sa.operatorSelector) === null ? { operatorSelector: nullComp } : {}), ((_ta = props.controlElements) == null ? void 0 : _ta.valueSourceSelector) === null ? { valueSourceSelector: nullComp } : {}), ((_ua = props.controlElements) == null ? void 0 : _ua.actionElement) ? {
      addGroupAction: ((_va = props.controlElements) == null ? void 0 : _va.addGroupAction) === null ? nullComp : (_xa = (_wa = props.controlElements) == null ? void 0 : _wa.addGroupAction) != null ? _xa : props.controlElements.actionElement,
      addRuleAction: ((_ya = props.controlElements) == null ? void 0 : _ya.addRuleAction) === null ? nullComp : (_Aa = (_za = props.controlElements) == null ? void 0 : _za.addRuleAction) != null ? _Aa : props.controlElements.actionElement,
      cloneGroupAction: ((_Ba = props.controlElements) == null ? void 0 : _Ba.cloneGroupAction) === null ? nullComp : (_Da = (_Ca = props.controlElements) == null ? void 0 : _Ca.cloneGroupAction) != null ? _Da : props.controlElements.actionElement,
      cloneRuleAction: ((_Ea = props.controlElements) == null ? void 0 : _Ea.cloneRuleAction) === null ? nullComp : (_Ga = (_Fa = props.controlElements) == null ? void 0 : _Fa.cloneRuleAction) != null ? _Ga : props.controlElements.actionElement,
      lockGroupAction: ((_Ha = props.controlElements) == null ? void 0 : _Ha.lockGroupAction) === null ? nullComp : (_Ja = (_Ia = props.controlElements) == null ? void 0 : _Ia.lockGroupAction) != null ? _Ja : props.controlElements.actionElement,
      lockRuleAction: ((_Ka = props.controlElements) == null ? void 0 : _Ka.lockRuleAction) === null ? nullComp : (_Ma = (_La = props.controlElements) == null ? void 0 : _La.lockRuleAction) != null ? _Ma : props.controlElements.actionElement,
      removeGroupAction: ((_Na = props.controlElements) == null ? void 0 : _Na.removeGroupAction) === null ? nullComp : (_Pa = (_Oa = props.controlElements) == null ? void 0 : _Oa.removeGroupAction) != null ? _Pa : props.controlElements.actionElement,
      removeRuleAction: ((_Qa = props.controlElements) == null ? void 0 : _Qa.removeRuleAction) === null ? nullComp : (_Sa = (_Ra = props.controlElements) == null ? void 0 : _Ra.removeRuleAction) != null ? _Sa : props.controlElements.actionElement
    } : {}), ((_Ta = props.controlElements) == null ? void 0 : _Ta.valueSelector) ? {
      combinatorSelector: ((_Ua = props.controlElements) == null ? void 0 : _Ua.combinatorSelector) === null ? nullComp : (_Wa = (_Va = props.controlElements) == null ? void 0 : _Va.combinatorSelector) != null ? _Wa : props.controlElements.valueSelector,
      fieldSelector: ((_Xa = props.controlElements) == null ? void 0 : _Xa.fieldSelector) === null ? nullComp : (_Za = (_Ya = props.controlElements) == null ? void 0 : _Ya.fieldSelector) != null ? _Za : props.controlElements.valueSelector,
      operatorSelector: ((__a = props.controlElements) == null ? void 0 : __a.operatorSelector) === null ? nullComp : (_ab = (_$a = props.controlElements) == null ? void 0 : _$a.operatorSelector) != null ? _ab : props.controlElements.valueSelector,
      valueSourceSelector: ((_bb = props.controlElements) == null ? void 0 : _bb.valueSourceSelector) === null ? nullComp : (_db = (_cb = props.controlElements) == null ? void 0 : _cb.valueSourceSelector) != null ? _db : props.controlElements.valueSelector
    } : {});
    return __spreadValues(__spreadValues(__spreadValues({}, defaultControlElements), contextControlElements), propsControlElements);
...
var useQueryBuilderSetup = (props) => {
  ...
  const getRuleDefaultOperator = useCallback2(
    (field) => {
      ...
      const ops = (_a = getOperatorsMain(field, { fieldData })) != null ? _a : (
        /* istanbul ignore next */
        []
      );
  ...
  const getValueEditorTypeMain = useCallback2(
    (field, operator, { fieldData }) => {
      ...
      return (_a = getValueEditorType == null ? void 0 : getValueEditorType(field, operator, { fieldData })) != null ? _a : "text";
    },
    [getValueEditorType]
  );
  ...
  const getRuleDefaultValue = useCallback2(
    (r) => {
      var _a;
      const fieldData = (_a = fieldMap[r.field]) != null ? _a : {};
  ...
  const createRule = useCallback2(() => {
    ...
    const valueSource = (_a = getValueSourcesMain(field, operator)[0]) != null ? _a : "value";
    const newRule = {
      id: idGenerator(),
      field,
      operator,
...
var useRule = (props) => {
  ...
  const fieldBasedClassName = useMemo6(() => {
    var _a;
...
var Rule = React9.memo((props) => {
  ...
  return /* @__PURE__ */ React9.createElement(
    ...
    /* @__PURE__ */ React9.createElement(RuleComponents, __spreadValues({}, r))
  );
});
...
var RuleGroup = React10.memo((props) => {
  ...
  return /* @__PURE__ */ React10.createElement(
    ...
    /* @__PURE__ */ React10.createElement("div", { ref: rg.dropRef, className: rg.classNames.header }, /* @__PURE__ */ React10.createElement(RuleGroupHeaderComponents, __spreadValues({}, rg))),
    /* @__PURE__ */ React10.createElement("div", { className: rg.classNames.body }, /* @__PURE__ */ React10.createElement(RuleGroupBodyComponents, __spreadValues({}, rg)))
  );
});
